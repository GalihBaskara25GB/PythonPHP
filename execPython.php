<html>
    ...
    <body>
        ...
        <div class="row">
            <div class="col-md-3 bg-dark text-white" style="min-height: 668px">
                <center>
    ...
    <?php
        $file = 'D:/xampp/htdocs/PythonPHP/VisualizingData.py';
        if(file_exists($file)) {
            echo '<div class="alert alert-info" role="alert">File is exist, and placed in '.$file.'</div>';
            ...
            if($output) {
                ...
                src="report.html" height="525" width="100%">
                    </iframe>
                </div>';
            }
